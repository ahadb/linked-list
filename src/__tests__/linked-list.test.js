...
describe('LinkedList Class', () => {
  ...
  it('should append node to linked list', () => {
    ...
    expect(singlyLinkedList.head).toEqual({ value: 1, next: {value: 2, next: null} });
    expect(singlyLinkedList.tail).toEqual({ value: 2, next: null });
  ...
  it('should prepend node to linked list', () => {
    ...
    expect(singlyLinkedList.head).toEqual({ value: 2, next: null });
    expect(singlyLinkedList.tail).toEqual({ value: 2, next: null });
